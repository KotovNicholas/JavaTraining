 ...
 */
public class PowerMetal extends aTrack {
    ...
    public PowerMetal(String name, String group, Integer trackLength) {
        this.name = name;
        this.group = group;
    ...
    public boolean equals(Object o) {
        ...
        PowerMetal that = (PowerMetal) o;

        if (!name.equals(that.name)) return false;
        if (!group.equals(that.group)) return false;
        return trackLength.equals(that.trackLength);
